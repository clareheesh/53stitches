...
<!-- Hero -->
<div
        class="hero module module-hero <?= $image_as_bg ? 'hero--background-image' : ''; ?>"
				<?= $image_as_bg ? 'style="background-image: url(' . $image['url'] . ');"' : ''; ?>>
        ...
        <p class="difficulty__label"><span class="difficulty difficulty--green difficulty--1"></span> <?= $subheading; ?></p>
          ...
          <div class="hero__buttons">
                    ...
                    <a href="<?= $button['link']['url']; ?>"
                       class="btn btn-primary read-more"><?= isset($button['text']) && $button['text'] ? $button['text'] : 'See More'; ?></a>
							<?php endif; ?>
						<?php endforeach; ?>
          </div>
			<?php endif; ?>
