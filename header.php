...
<header>
	...
	<?php wp_nav_menu( ['menu' => 'main-menu', 'menu_class' => 'main-menu', 'container' => 'div'] ); ?>
	...
	<ul class="social-media">
		...
		<li><a href="//www.etsy.com/shop/53stitches" rel="nofollow" target="_blank"><i class="fa fa-etsy"></i></a></li>
	</ul>
