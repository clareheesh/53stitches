<?php
	...
	function stitch_scripts() {
		...
		wp_enqueue_style('sf-style', get_stylesheet_uri(), array(), '18.9.25.2');
	}
	...
	function stitch_insta() {
		...
		the_widget('null_instagram_widget', array('size' => 'large', 'number' => 3, 'target' => '_blank', 'username' => '53stitches'), []);
	...
	function stitch_register_sidebar() {
		...
		register_sidebar(['name' => 'Sidebar', 'id' => 'default-sidebar']);
	}