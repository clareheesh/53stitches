    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col col-12 col-lg-8">
          <div class="featured-post__image label-container" style="background-image: url('<?= get_the_post_thumbnail_url($single, 'full'); ?>');">
          ...
          <div class="select-container">
            <select name="tag" class="js-tag-filter">
              <?php foreach($tags as $i => $tag) : ?>
                <option <?= get_queried_object()->term_id == $tag->term_id ? 'selected' : ''; ?> value="<?= $tag->slug; ?>"><?= $tag->name; ?></option>
              <?php endforeach; ?>
            </select>
