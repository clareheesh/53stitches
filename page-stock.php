				...
				<div class="entry-content col-xs-12">
					...
					<div class="row">
						...
						<div class="stock-tally col-xs-6 col-sm-3">
							<a id="stock_level" class="btn btn-success btn-block btn-stock" href="#"><span class="i"><span
										class="i"><?= $total; ?></span></span><br>Dolls in Stock</a>
						</div>
						
						<div class="stock-tally col-xs-6 col-sm-3">
							<a id="max_value" class="btn btn-info btn-block btn-stock" href="#"><i class="fa fa-4x fa-dollar"> </i><br>Max value is
								$<?= $possible_profit; ?>
							</a>
						</div>
						...
						<div class="stock-tally col-xs-6 col-sm-3">
							...
							<a href="<?= site_url(); ?>/supanova" class="btn btn-warning btn-block btn-stock"><i
									class="fa fa-clock-o fa-4x"></i><br><?= $days_to_supanova; ?> Days until Supanova</a>
						</div>
						
						<div class="stock-tally col-xs-6 col-sm-3">
							<a id="sync_etsy" class="btn btn-primary btn-block btn-stock" href="#"><i class="fa fa-4x fa-cloud-download"> </i><br>Sync
								with Etsy</a>
						</div>
					</div>
							...
							<table id="dolls" class="table table-striped table-hover" cellspacing="0" width="100%">
								...
								<?php foreach ($dolls as $key => $doll) : ?>
									...
									<tr class="doll-<?= $doll->ID; ?>">
										...
										<td class="doll_link"
												data-val="<?= $doll_link; ?>"><?= $doll_link ? '<a href="' . $doll_link . '" target="_blank" rel="nofollow">Doll Link</a>' : ''; ?></td>
										<td class="pattern_link"
												data-val="<?= $pattern_link; ?>"><?= $pattern_link ? '<a href="' . $pattern_link . '" target="_blank" rel="nofollow">Pattern Link</a>' : ''; ?></td>
										<td class="sales" data-val="<?= $sales; ?>"><?= $sales; ?></td>
										<td class="favourites" data-toggle="tooltip" data-placement="right" title="Total: <?= $favourites; ?>"
